...
func PrintWelcome() {
	...
	fmt.Println("This is version 0.0.1(alpha) of the game. You can also check the version using the command \"version\"")
	fmt.Println("This is a text-based stategic game where you can play against an AI in a pokemon battle.\nYou can also search for a pokemon name to see it's card")
